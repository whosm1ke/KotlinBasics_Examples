...
// Оголошення об'єкта Typography для налаштування типографіки Material Design
// Використовується для визначення стилів тексту у компонентах Compose
val Typography = Typography(
    ...
    /*
    // Наступні стилі можуть бути додані для розширення типографіки:
