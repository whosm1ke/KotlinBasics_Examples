 ...
 */
@RunWith(AndroidJUnit4::class) // Вказує, що тест буде виконуватися на Android пристрої з використанням AndroidJUnit4
class ExampleInstrumentedTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("ua.kpi.practical_example_8", appContext.packageName)
    }
}